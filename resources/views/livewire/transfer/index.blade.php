    ...
    <div class="sm:hidden divide-y divide-gray-100">
        ...
        <div class="px-4 py-3 space-y-1.5">
            ...
            <div class="flex items-center gap-1 pt-0.5">
                <button wire:click="editTransfer({{ $tr->id }})" class="inline-flex items-center gap-1.5 px-3 py-2 min-h-10 hover:bg-blue-100 text-blue-600 rounded-xl transition font-medium text-xs">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    <span>Edit</span>
                </button>
                <button wire:click="confirmDelete({{ $tr->id }})" class="inline-flex items-center gap-1.5 px-3 py-2 min-h-10 hover:bg-red-100 text-red-500 rounded-xl transition font-medium text-xs">

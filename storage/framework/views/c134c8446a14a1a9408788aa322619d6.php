...
<head>
    ...
    <title>Login – <?php echo e(\App\Models\Setting::get('app_name', 'Keuangan Mushola')); ?></title>
...
<body class="min-h-screen bg-gradient-to-br from-primary-800 via-primary-700 to-emerald-600 flex items-center justify-center p-4 font-sans">
    ...
    <div class="relative w-full max-w-sm">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <?php $loginFoto = \App\Models\Setting::get('foto_mushola'); ?>
            <div class="flex justify-center mb-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loginFoto): ?>
                <img src="<?php echo e(Storage::url($loginFoto)); ?>" class="w-16 h-16 rounded-2xl object-cover shadow-lg">
                <?php else: ?>
            ...
            <h1 class="text-2xl font-extrabold text-gray-900 text-center mb-1"><?php echo e(\App\Models\Setting::get('app_name', 'Keuangan Mushola')); ?></h1>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 text-center">
                ...
                <a href="<?php echo e(route('home')); ?>" class="inline-block mt-3 text-xs text-primary-600 font-semibold hover:underline">← Kembali ke Beranda</a>
            </div>
        </div>

        <p class="text-center text-white/60 text-xs mt-6">
            © <?php echo e(date('Y')); ?> <?php echo e(\App\Models\Setting::get('nama_mushola', '')); ?> · <?php echo e(\App\Models\Setting::get('app_name', 'Keuangan Mushola')); ?>

        </p>
    </div>
</body>
</html>
<?php /**PATH /srv/apkpulsa/web/mushola-finance/resources/views/auth/login.blade.php ENDPATH**/ ?>
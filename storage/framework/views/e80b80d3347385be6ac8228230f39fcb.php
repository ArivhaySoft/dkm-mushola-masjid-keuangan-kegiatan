...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.header','data' => ['title' => $title ?? 'Beranda']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)"
    ...
    <div class="flex items-center gap-3 bg-white border border-emerald-200 rounded-2xl shadow-lg p-4">
        ...
        <p class="text-sm text-gray-700 font-medium"><?php echo e(session('success')); ?></p>
    </div>
    ...
    <div class="flex items-center gap-3 bg-white border border-red-200 rounded-2xl shadow-lg p-4">
        ...
        <p class="text-sm text-gray-700 font-medium"><?php echo e(session('error')); ?></p>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /srv/apkpulsa/web/mushola-finance/resources/views/components/layouts/app.blade.php ENDPATH**/ ?>
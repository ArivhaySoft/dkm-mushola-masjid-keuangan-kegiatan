...
<aside class="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-primary-800 text-white flex flex-col"
    ...
    <div class="flex items-center gap-3 px-4 py-4 border-b border-white/10">
        ...
        <img src="<?php echo e(Storage::url($fotoMushola)); ?>" class="w-10 h-10 rounded-xl object-cover shadow-lg flex-shrink-0">
        <?php else: ?>
        ...
        <div class="min-w-0">
            <p class="font-extrabold text-sm text-white leading-tight"><?php echo e(\App\Models\Setting::get('app_name', 'Keuangan Mushola')); ?></p>
            <p class="text-xs text-primary-300"><?php echo e(\App\Models\Setting::get('nama_mushola', '')); ?></p>
        </div>
    </div>

    <nav class="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
        <a href="<?php echo e(route('home')); ?>" class="sidebar-link <?php echo e(request()->routeIs('home') ? 'active' : 'text-primary-200'); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            Halaman Publik
        </a>
        <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('arus-kas')); ?>" class="sidebar-link <?php echo e(request()->routeIs('arus-kas') ? 'active' : 'text-primary-200'); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
            Arus Kas
        </a>
        <a href="<?php echo e(route('transfer.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('transfer.*') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('laporan.periodik')); ?>" class="sidebar-link <?php echo e(request()->routeIs('laporan.periodik') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('laporan.bulanan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('laporan.bulanan') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('laporan.tahunan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('laporan.tahunan') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('kegiatan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('kegiatan') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('master.rekening')); ?>" class="sidebar-link <?php echo e(request()->routeIs('master.rekening') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('master.kategori')); ?>" class="sidebar-link <?php echo e(request()->routeIs('master.kategori') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('master.jenis-kegiatan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('master.jenis-kegiatan') ? 'active' : 'text-primary-200'); ?>">
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()?->isAdmin()): ?>
        <a href="<?php echo e(route('hak-akses')); ?>" class="sidebar-link <?php echo e(request()->routeIs('hak-akses') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('reset-data')); ?>" class="sidebar-link <?php echo e(request()->routeIs('reset-data') ? 'active' : 'text-primary-200'); ?>">
        ...
        <a href="<?php echo e(route('pengaturan')); ?>" class="sidebar-link <?php echo e(request()->routeIs('pengaturan') ? 'active' : 'text-primary-200'); ?>">
    ...
    <div class="p-3 border-t border-white/10">
        <a href="<?php echo e(route('profile')); ?>" class="flex items-center gap-3 p-2 rounded-xl hover:bg-white/10 transition">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()?->avatar): ?>
                <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-9 h-9 rounded-full ring-2 ring-gold-400 flex-shrink-0">
            <?php else: ?>
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-white truncate leading-tight"><?php echo e(auth()->user()?->name); ?></p>
                <p class="text-xs text-primary-300 truncate"><?php echo e(auth()->user()?->roles->pluck('label')->join(', ') ?: 'Viewer'); ?></p>
            </div>
        </a>
...
<?php /**PATH /srv/apkpulsa/web/mushola-finance/resources/views/components/sidebar.blade.php ENDPATH**/ ?>
    ...
    <div class="sm:hidden divide-y divide-gray-100">
        ...
        <div class="px-4 py-3 space-y-1">
            <div class="flex items-start justify-between">
                <div>
                    <p class="font-semibold text-gray-800 text-sm"><?php echo e($r->nama_rek); ?></p>
                    <p class="text-[11px] text-gray-400"><?php echo e($r->atas_nama); ?> &middot; <?php echo e($r->no_rek); ?></p>
                </div>
                <span class="text-sm font-bold <?php echo e($r->saldo >= 0 ? 'text-emerald-600' : 'text-red-500'); ?>">
                    Rp <?php echo e(number_format($r->saldo, 0, ',', '.')); ?>

                </span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()?->isAdmin()): ?>
            <div class="flex items-center gap-1">
                <button wire:click="openEdit(<?php echo e($r->id); ?>)" class="p-1 hover:bg-blue-100 text-blue-600 rounded-lg transition">
                    <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                </button>
                <button wire:click="confirmDeleteItem(<?php echo e($r->id); ?>)" class="p-1 hover:bg-red-100 text-red-500 rounded-lg transition">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 font-semibold text-gray-800"><?php echo e($r->nama_rek); ?></td>
                    <td class="px-4 py-3 text-gray-600"><?php echo e($r->atas_nama); ?></td>
                    <td class="px-4 py-3 text-gray-600 font-mono"><?php echo e($r->no_rek); ?></td>
                    <td class="px-4 py-3 text-right font-bold <?php echo e($r->saldo >= 0 ? 'text-emerald-600' : 'text-red-500'); ?>">
                        Rp <?php echo e(number_format($r->saldo, 0, ',', '.')); ?>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex justify-center gap-1">
                            <button wire:click="openEdit(<?php echo e($r->id); ?>)"
                            ...
                            <button wire:click="confirmDeleteItem(<?php echo e($r->id); ?>)"
...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
    <div class="bg-white rounded-2xl w-full max-w-sm shadow-2xl">
        <div class="flex items-center justify-between px-5 py-4 border-b">
            <h3 class="font-bold text-gray-800"><?php echo e($editId ? 'Edit' : 'Tambah'); ?> Rekening</h3>
        ...
        <div class="p-5 space-y-4">
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nama_rek'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['atas_nama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-xs text-red-500 mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['no_rek'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-xs text-red-500 mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
</div><?php /**PATH /srv/apkpulsa/web/mushola-finance/resources/views/livewire/master/rekening.blade.php ENDPATH**/ ?>
...
<header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-10 flex-shrink-0">
    ...
    <div class="flex-1 min-w-0">
        <h1 class="text-base font-bold text-gray-800 truncate"><?php echo e($title ?? 'Beranda'); ?></h1>
    </div>
    <div class="hidden sm:flex items-center gap-3 text-right flex-shrink-0">
        <div>
            <p class="text-xs font-semibold text-gray-600"><?php echo e(now()->isoFormat('dddd')); ?></p>
            <p class="text-xs text-gray-400"><?php echo e(now()->isoFormat('D MMM Y')); ?></p>
        </div>
        ...
        <a href="<?php echo e(route('profile')); ?>" class="flex-shrink-0">
            <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-8 h-8 rounded-full ring-2 ring-primary-200">
        </a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</header>
<?php /**PATH /srv/apkpulsa/web/mushola-finance/resources/views/components/header.blade.php ENDPATH**/ ?>